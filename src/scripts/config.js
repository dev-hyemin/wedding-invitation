...
export const CONFIG = {
  ...
  transport: {
    ...
    car:     '교회 주차장이 협소하여 친인척 위주로 운영되오니 근처 공영주차장을 이용 바랍니다.\n\n- 제1공영 노외주차장: 복개천 북단 (수택동 528번지)\n\- 제4공영 노외주차장: 복개천 남단 (수택동 528번지)\n\n- 제5공영 노외주차장: 복개천 남단 (수택동 528번지)\n\n- 검배근린공원공영주차장: 경기 구리시 수택동 산 2-4\n※ 검배근린공원공영주차장 이용 시 셔틀버스 운행',
  },
}
